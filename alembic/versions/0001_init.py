...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("paiement_confirme", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        ...
        sa.Column("certification", sa.Boolean(), server_default=sa.text("0"), nullable=False),
