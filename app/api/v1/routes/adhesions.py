...
async def create_adhesion(
    ...
    est_diaspora: bool = Form(False),
    niveau_etude: str | None = Form(None),
    annees_experience: int | None = Form(None),
    biographie: str | None = Form(None),
    region_domicile_id: uuid.UUID | None = Form(None),
    departement_domicile_id: uuid.UUID | None = Form(None),
    commune_domicile_id: uuid.UUID | None = Form(None),
    region_militantisme_id: uuid.UUID | None = Form(None),
    departement_militantisme_id: uuid.UUID | None = Form(None),
    commune_militantisme_id: uuid.UUID | None = Form(None),
    pays_domicile_id: uuid.UUID | None = Form(None),
    ville_domicile: str | None = Form(None),
    ...
    data = CreateAdhesionInput(
        ...
        pays_domicile_id=pays_domicile_id,
        ville_domicile=ville_domicile,
        pays_militantisme_id=pays_militantisme_id,
        ville_militantisme=ville_militantisme,
        fonction_professionnelle=fonction_professionnelle,
        engagement=engagement,
        commissariat=commissariat,
        commissariat_scientifique_principal=commissariat_scientifique_principal,
        commissariat_scientifique_secondaire=commissariat_scientifique_secondaire,
